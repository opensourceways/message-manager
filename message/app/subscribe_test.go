...
func (m *MockMessageSubscribeAdapter) GetSubsConfig(userName string) (
	[]MessageSubscribeDTOWithPushConfig, int64, error) {
	args := m.Called(userName)
...
func (m *MockMessageSubscribeAdapter) UpdateSubsConfig(cmd CmdToUpdateSubscribe,
